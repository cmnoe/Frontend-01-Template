function match(selector, element) {
  ...
  const element_arr = selector.split(" ").filter((s) => s.charAt(0) !== "#" && s.charAt(0) !== "." && s.charAt(0) !== '[');
  ...
  if (parentheses_arr) {
    const split_parentheses = parentheses_arr[0].substring(1, parentheses_arr[0].length - 1).split("=");
